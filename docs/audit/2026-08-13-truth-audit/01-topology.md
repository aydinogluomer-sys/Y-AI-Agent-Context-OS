...
> Baseline commit: `b3b060c6b442e60ee22f2b9b4c149033a96ad726`
...
| Şema | **Hiç `.sql` dosyası yok** (74 adet) — 1105 satırlık `db.ts` içinde inline string | `apps/api/src/db.ts` |
...
| `packages/security` | 10 | 2490 | wired (31 importer) |
