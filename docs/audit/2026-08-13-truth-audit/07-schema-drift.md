...
`04-db-inventory.csv`: **56 tablonun 45'inde**
...
| Sınıf | Tablolar |
|---|---|
| DEAD (0 okuma, 0 yazma) | `memberships`, `artifacts`, `connections`, `context_summaries`, `service_identities`, `orphaned_memberships`, `repositories`, `repository_connections`, `orphaned_repo_sources` |
| WRITE-ONLY (hiç okunmuyor) | `durable_memories`, `boundary_checks`, `repo_access_logs`, `permission_overrides`, `files`, `parser_versions` |
