...
`04-db-inventory.csv`: **62 tablonun 42'inde**
...
| Sınıf | Tablolar |
|---|---|
| DEAD (0 okuma, 0 yazma) | `memberships`, `artifacts`, `connections`, `context_summaries`, `service_identities`, `orphaned_memberships`, `repository_connections`, `orphaned_repo_sources`, `legacy_chunk_migration_audit`, `retrieval_runs`, `retrieval_candidates` |
